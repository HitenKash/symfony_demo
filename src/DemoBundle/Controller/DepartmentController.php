...
use DemoBundle\Entity\Department;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $departments = $em->getRepository('DemoBundle:Department')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DemoBundle\Form\DepartmentType', $department);
    ...
    {
        $deleteForm = $this->createDeleteForm($department);
        $editForm = $this->createForm('DemoBundle\Form\DepartmentType', $department);
