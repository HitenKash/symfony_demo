...
class EmployeeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $employees = $em->getRepository('DemoBundle:Employee')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DemoBundle\Form\EmployeeType', $employee);
    ...
    {
        $deleteForm = $this->createDeleteForm($employee);
        $editForm = $this->createForm('DemoBundle\Form\EmployeeType', $employee);
